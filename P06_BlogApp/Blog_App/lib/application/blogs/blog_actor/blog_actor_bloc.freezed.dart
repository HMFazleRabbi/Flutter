...
// ignore: unused_element
  _DeleteFailure deleteFailure(BlogFailure blogFailure) {
...
mixin _$BlogActorState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult deleteFailure(BlogFailure blogFailure),
  ...
  TResult maybeWhen<TResult extends Object>({
    ...
    TResult deleteFailure(BlogFailure blogFailure),
...
/// @nodoc
class __$InitialCopyWithImpl<$Res> extends _$BlogActorStateCopyWithImpl<$Res>
...
abstract class _Initial implements BlogActorState {
...
abstract class _ActionInProgress implements BlogActorState {
...
class _$_DeleteFailure implements _DeleteFailure {
  const _$_DeleteFailure(this.blogFailure) : assert(blogFailure != null);
  ...
  @override
  String toString() {
    return 'BlogActorState.deleteFailure(blogFailure: $blogFailure)';
  }
  ...
  TResult when<TResult extends Object>({
    ...
    assert(deleteFailure != null);
    assert(deleteSuccess != null);
    return deleteFailure(blogFailure);
  }
...
abstract class _DeleteFailure implements BlogActorState {
  const factory _DeleteFailure(BlogFailure blogFailure) = _$_DeleteFailure;
...
abstract class _DeleteSuccess implements BlogActorState {
